...
pub const Memory = struct {
    ...
    pub fn readByte(self: *Memory, address: u16) u8 {
        return switch (address) {
            ...
            0xFE00...0xFE9F => self.oam.bytes[address - 0xFE00],
            0xFF00...0xFF7F => self.io.bytes[address - 0xFF00],
    ...
    pub fn writeByte(self: *Memory, address: u16, value: u8) void {
        switch (address) {
            ...
            0xFE00...0xFE9F => self.oam.bytes[address - 0xFE00] = value,
            0xFF00...0xFF7F => self.io.bytes[address - 0xFF00] = value,
...
const Io = struct { bytes: [128]u8 = [_]u8{0} ** 128 };
const Oam = struct { bytes: [160]u8 = [_]u8{0} ** 160 };
